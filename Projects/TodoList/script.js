...
// const info = document.querySelector("#in-hover-hid");
// info.addEventListener("click", openInfoBox);


// function openInfoBox() {
//     const infoBox = document.querySelector("#infoBody");
//     console.log(infoBox)
//     infoBox.style = "display:block; transition: all 20s"
// }
